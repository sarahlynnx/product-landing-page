...
const flavorImages = {
    'DARK CHOCOLATE': {
        'DARK CHOCOLATE + SEA SALT': {
            ...
            backgroundGradient: '-webkit-linear-gradient(190deg, #89d1ee 5%, #47a6cb 53%, #006e99 91%)',  
        ...
        'DARK CHOCOLATE + BLUEBERRIES': {
            ...
            backgroundGradient: '-webkit-linear-gradient(190deg, #26A6D7 5%, #295ac8 67%, #0c3eb9 91%)',  
        ...
        'DARK CHOCOLATE + CHERRIES': {
            ...
            backgroundGradient: '-webkit-linear-gradient(190deg, #D84764 5%, #C9293D 53%, #9F202A 91%)',  
    ...
    'MILK CHOCOLATE': {
        'MILK CHOCOLATE': {
            ...
            backgroundGradient: '-webkit-linear-gradient(190deg, #EB8B34 5%, #D16118 53%, #C74A01 91%)',  
        ...
        'MILK CHOCOLATE + CURRANTS': {
            ...
            backgroundGradient: '-webkit-linear-gradient(190deg, #B769A4 5%, #8D4DA1 53%, #610D76 91%)',  
